...
// END. FIXO PARA DS1307: 1101000X, ONDE X = 0 È PARA GRAVAÁ„O
   I2C1_Wr(0);            
// END. ONDE COMEÁA A PROGRAMAÁ„O DO RELÛGIO, END. DOS SEGUNDOS.
   I2C1_Wr(0x00);         // INICIA COM 55 SEGUNDOS.
   I2C1_Wr(0x30);         // INICIA COM 58 MINUTOS.
   I2C1_Wr(0x09);         // INICIA COM 23 h (FORMATO 24 HORAS).
   I2C1_Wr(0x03);         // INICIA COM TERÁA-FEIRA
   I2C1_Wr(0x28);         // INICIA COM DIA 24
   I2C1_Wr(0x09);         // INICIA COM MÍS 12
   I2C1_Wr(0x94);         // INICIA COM ANO 2014
   I2C1_Stop();}          // FINALIZA COMUNICAÁ„O I2C
/****************************************************************************/
void Encontra_Dia_Semana() {
   switch (ucDia_Semana) {
